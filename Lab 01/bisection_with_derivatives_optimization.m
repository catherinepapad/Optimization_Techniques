...
for l = linspace(0.0001,0.1,100)
    disp(count);
    [~ , ~ , k_f1_values2(count)] = bisection_with_derivatives_algorithm(f1 , l , a1 , b1);
    [~ , ~ , k_f2_values2(count)] = bisection_with_derivatives_algorithm(f2 , l , a1 , b1);
    [~ , ~ , k_f3_values2(count)] = bisection_with_derivatives_algorithm(f3 , l , a1 , b1);
    l_values(count) = l;
    count = count +1;
end
...
[ak_1 , bk_1 , k_1] = bisection_with_derivatives_algorithm(f1 , l1 , a1 , b1);
[ak_2 , bk_2 , k_2] = bisection_with_derivatives_algorithm(f1 , l2 , a1 , b1);
[ak_3 , bk_3 , k_3] = bisection_with_derivatives_algorithm(f1 , l3 , a1 , b1);
[ak_4 , bk_4 , k_4] = bisection_with_derivatives_algorithm(f1 , l4 , a1 , b1);
...
[ak_1 , bk_1 , k_1] = bisection_with_derivatives_algorithm(f2 , l1 , a1 , b1);
[ak_2 , bk_2 , k_2] = bisection_with_derivatives_algorithm(f2 , l2 , a1 , b1);
[ak_3 , bk_3 , k_3] = bisection_with_derivatives_algorithm(f2 , l3 , a1 , b1);
[ak_4 , bk_4 , k_4] = bisection_with_derivatives_algorithm(f2 , l4 , a1 , b1);
...
[ak_1 , bk_1 , k_1] = bisection_with_derivatives_algorithm(f3 , l1 , a1 , b1);
[ak_2 , bk_2 , k_2] = bisection_with_derivatives_algorithm(f3 , l2 , a1 , b1);
[ak_3 , bk_3 , k_3] = bisection_with_derivatives_algorithm(f3 , l3 , a1 , b1);
[ak_4 , bk_4 , k_4] = bisection_with_derivatives_algorithm(f3 , l4 , a1 , b1);
