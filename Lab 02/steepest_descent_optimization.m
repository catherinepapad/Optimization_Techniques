...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = steepest_descent_algorithm_constant_g(f, x1, e, g);
...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = steepest_descent_algorithm_min_g(f, x1, e, l);
...
figure
fcontour(fhandle,[-3.5 3.5 -3 3],'LevelList', -1.5:0.1:1.5);
xlabel('x'); 
ylabel('y'); 
colorbar
hold on
...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = steepest_descent_armijo(f, x1, e);
