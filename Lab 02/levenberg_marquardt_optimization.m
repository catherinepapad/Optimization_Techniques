...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = levenberg_marquardt_algorithm_constant_g(f, x1, e, g);
...
ylabel('y'); 
zlabel('f(x,y)');
text = ['Constant $\gamma_k$ = ' , num2str(g), ' , Initial point (-1,1)'];
...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = levenberg_marquardt_algorithm_min_g(f, x1, e, l);
...
%First x1
x1 = [0; 0];
[xk , fvalues, dfvalues, k] = levenberg_marquardt_algorithm_armijo(f, x1, e);
